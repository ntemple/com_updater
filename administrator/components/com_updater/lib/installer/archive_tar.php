...
// +----------------------------------------------------------------------+
//
// $Id: archive_tar.php 2 2009-08-24 06:50:12Z sadgroup $

// Check to ensure this file is within the rest of the framework
defined('JPATH_BASE') or die();

// This is an updated version over what is included with the Joomla! core
// We take special care not to pollute the namespace.
...
* @package  Archive
*/
class ISArchive_Tar extends PEAR
{
    /**
    ...
    * @access public
    */
    function ISArchive_Tar($p_tarname, $p_compress = null)
    {
        $this->PEAR();
