<?php
/* SVN FILE: $Id: utils.inc.php 2 2009-08-24 06:50:12Z sadgroup $*/
/**
 * 
 ...
 * @license    LGPL 2.1
 * @version    SVN: $Id: utils.inc.php 2 2009-08-24 06:50:12Z sadgroup $
...
// Pure PHP function to gzdecode files
...
function validate_email($email, $checkdomain = false)
{
   ...
   if (eregi($regexp, $email)) {
     ...
     if ($checkdomain) {
       ...
       if (! getmxrr($domaintld,$mxrecords))  $valid = 0;
     }
   }
   return $valid;
}
